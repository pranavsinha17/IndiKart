...
public class AdminAddProduct extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        AddNewProductButton = (Button) findViewById(R.id.bt1);
        InputProductImage = (ImageView) findViewById(R.id.select_product_image);
        InputProductName = (EditText) findViewById(R.id.ed1);
        InputProductDescription = (EditText) findViewById(R.id.ed2);
        InputProductPrice = (EditText) findViewById(R.id.ed3);
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            Intent intent = new Intent(AdminAddProduct.this, CatagoryActivity.class);
